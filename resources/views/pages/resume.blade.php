...
<ol >
    <li class="border-l-2 odd:border-green-600 even:border-purple-600">
        <div class="md:flex flex-start" id="2025">
          ...
          <div class="block p-6 rounded-lg shadow-lg bg-gray-100 max-w-md ml-6 mb-10">
            <div class="flex justify-between mb-4">
              <a href="#2025" class="font-medium text-purple-600 hover:text-purple-700 focus:text-purple-800 duration-300 transition ease-in-out text-sm">2025</a>
            </div>
